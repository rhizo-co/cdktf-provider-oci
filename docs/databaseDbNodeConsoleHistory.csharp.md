...
new DatabaseDbNodeConsoleHistory(Construct Scope, string Id, DatabaseDbNodeConsoleHistoryConfig Config);
```
...
```csharp
private void PutTimeouts(DatabaseDbNodeConsoleHistoryTimeouts Value)
```
...
DatabaseDbNodeConsoleHistory.IsConstruct(object X);
```
...
DatabaseDbNodeConsoleHistory.IsTerraformElement(object X);
```
...
DatabaseDbNodeConsoleHistory.IsTerraformResource(object X);
```
...
DatabaseDbNodeConsoleHistory.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.cdktfStack">CdktfStack</a></code> | <code>HashiCorp.Cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>HashiCorp.Cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.connection">Connection</a></code> | <code>object</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.count">Count</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.lifecycle">Lifecycle</a></code> | <code>HashiCorp.Cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.provider">Provider</a></code> | <code>HashiCorp.Cdktf.TerraformProvider</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.provisioners">Provisioners</a></code> | <code>object[]</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.definedTagsInput">DefinedTagsInput</a></code> | <code>System.Collections.Generic.IDictionary<string, string></code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.freeformTagsInput">FreeformTagsInput</a></code> | <code>System.Collections.Generic.IDictionary<string, string></code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.timeoutsInput">TimeoutsInput</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.definedTags">DefinedTags</a></code> | <code>System.Collections.Generic.IDictionary<string, string></code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.freeformTags">FreeformTags</a></code> | <code>System.Collections.Generic.IDictionary<string, string></code> | *No description.* |
...
```csharp
public DatabaseDbNodeConsoleHistoryTimeoutsOutputReference Timeouts { get; }
```
...
new DatabaseDbNodeConsoleHistoryConfig {
    ...
    string Id = null,
    DatabaseDbNodeConsoleHistoryTimeouts Timeouts = null
};
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryConfig.property.connection">Connection</a></code> | <code>object</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryConfig.property.count">Count</a></code> | <code>object</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryConfig.property.dependsOn">DependsOn</a></code> | <code>HashiCorp.Cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryConfig.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryConfig.property.lifecycle">Lifecycle</a></code> | <code>HashiCorp.Cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryConfig.property.provider">Provider</a></code> | <code>HashiCorp.Cdktf.TerraformProvider</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryConfig.property.provisioners">Provisioners</a></code> | <code>object[]</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryConfig.property.definedTags">DefinedTags</a></code> | <code>System.Collections.Generic.IDictionary<string, string></code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/database_db_node_console_history#defined_tags DatabaseDbNodeConsoleHistory#defined_tags}. |
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryConfig.property.freeformTags">FreeformTags</a></code> | <code>System.Collections.Generic.IDictionary<string, string></code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/database_db_node_console_history#freeform_tags DatabaseDbNodeConsoleHistory#freeform_tags}. |
...
```csharp
public DatabaseDbNodeConsoleHistoryTimeouts Timeouts { get; set; }
```
...
new DatabaseDbNodeConsoleHistoryTimeouts {
    string Create = null,
    string Delete = null,
    string Update = null
};
...
new DatabaseDbNodeConsoleHistoryTimeoutsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryTimeoutsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryTimeoutsOutputReference.resolve.parameter._context"></a>
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryTimeoutsOutputReference.property.internalValue">InternalValue</a></code> | <code>object</code> | *No description.* |
