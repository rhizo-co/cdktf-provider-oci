...
```typescript
import { dataOciDatabaseAutonomousPatch } from 'rhizo-co-terraform-provider-oci'

new dataOciDatabaseAutonomousPatch.DataOciDatabaseAutonomousPatch(scope: Construct, id: string, config: DataOciDatabaseAutonomousPatchConfig)
```
...
dataOciDatabaseAutonomousPatch.DataOciDatabaseAutonomousPatch.isConstruct(x: any)
```
...
dataOciDatabaseAutonomousPatch.DataOciDatabaseAutonomousPatch.isTerraformElement(x: any)
```
...
dataOciDatabaseAutonomousPatch.DataOciDatabaseAutonomousPatch.isTerraformDataSource(x: any)
```
...
dataOciDatabaseAutonomousPatch.DataOciDatabaseAutonomousPatch.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseAutonomousPatch.DataOciDatabaseAutonomousPatch.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseAutonomousPatch.DataOciDatabaseAutonomousPatch.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseAutonomousPatch.DataOciDatabaseAutonomousPatch.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseAutonomousPatch.DataOciDatabaseAutonomousPatch.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseAutonomousPatch.DataOciDatabaseAutonomousPatch.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
```typescript
public readonly autonomousPatchIdInput: string;
```
...
```typescript
public readonly autonomousPatchId: string;
```
...
const dataOciDatabaseAutonomousPatchConfig: dataOciDatabaseAutonomousPatch.DataOciDatabaseAutonomousPatchConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseAutonomousPatch.DataOciDatabaseAutonomousPatchConfig.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseAutonomousPatch.DataOciDatabaseAutonomousPatchConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseAutonomousPatch.DataOciDatabaseAutonomousPatchConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseAutonomousPatch.DataOciDatabaseAutonomousPatchConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseAutonomousPatch.DataOciDatabaseAutonomousPatchConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
