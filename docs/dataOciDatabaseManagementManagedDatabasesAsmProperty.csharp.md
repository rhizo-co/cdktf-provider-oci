...
new DataOciDatabaseManagementManagedDatabasesAsmProperty(Construct Scope, string Id, DataOciDatabaseManagementManagedDatabasesAsmPropertyConfig Config);
```
...
DataOciDatabaseManagementManagedDatabasesAsmProperty.IsConstruct(object X);
```
...
DataOciDatabaseManagementManagedDatabasesAsmProperty.IsTerraformElement(object X);
```
...
DataOciDatabaseManagementManagedDatabasesAsmProperty.IsTerraformDataSource(object X);
```
...
DataOciDatabaseManagementManagedDatabasesAsmProperty.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabasesAsmProperty.DataOciDatabaseManagementManagedDatabasesAsmProperty.property.cdktfStack">CdktfStack</a></code> | <code>HashiCorp.Cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabasesAsmProperty.DataOciDatabaseManagementManagedDatabasesAsmProperty.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabasesAsmProperty.DataOciDatabaseManagementManagedDatabasesAsmProperty.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>HashiCorp.Cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabasesAsmProperty.DataOciDatabaseManagementManagedDatabasesAsmProperty.property.count">Count</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabasesAsmProperty.DataOciDatabaseManagementManagedDatabasesAsmProperty.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabasesAsmProperty.DataOciDatabaseManagementManagedDatabasesAsmProperty.property.lifecycle">Lifecycle</a></code> | <code>HashiCorp.Cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabasesAsmProperty.DataOciDatabaseManagementManagedDatabasesAsmProperty.property.provider">Provider</a></code> | <code>HashiCorp.Cdktf.TerraformProvider</code> | *No description.* |
...
```csharp
public DataOciDatabaseManagementManagedDatabasesAsmPropertyItemsList Items { get; }
```
...
new DataOciDatabaseManagementManagedDatabasesAsmPropertyConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabasesAsmProperty.DataOciDatabaseManagementManagedDatabasesAsmPropertyConfig.property.connection">Connection</a></code> | <code>object</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabasesAsmProperty.DataOciDatabaseManagementManagedDatabasesAsmPropertyConfig.property.count">Count</a></code> | <code>object</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabasesAsmProperty.DataOciDatabaseManagementManagedDatabasesAsmPropertyConfig.property.dependsOn">DependsOn</a></code> | <code>HashiCorp.Cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabasesAsmProperty.DataOciDatabaseManagementManagedDatabasesAsmPropertyConfig.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabasesAsmProperty.DataOciDatabaseManagementManagedDatabasesAsmPropertyConfig.property.lifecycle">Lifecycle</a></code> | <code>HashiCorp.Cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabasesAsmProperty.DataOciDatabaseManagementManagedDatabasesAsmPropertyConfig.property.provider">Provider</a></code> | <code>HashiCorp.Cdktf.TerraformProvider</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabasesAsmProperty.DataOciDatabaseManagementManagedDatabasesAsmPropertyConfig.property.provisioners">Provisioners</a></code> | <code>object[]</code> | *No description.* |
...
new DataOciDatabaseManagementManagedDatabasesAsmPropertyItems {
...
new DataOciDatabaseManagementManagedDatabasesAsmPropertyItemsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabasesAsmProperty.DataOciDatabaseManagementManagedDatabasesAsmPropertyItemsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabasesAsmProperty.DataOciDatabaseManagementManagedDatabasesAsmPropertyItemsList.resolve.parameter._context"></a>
...
```csharp
private DataOciDatabaseManagementManagedDatabasesAsmPropertyItemsOutputReference Get(double Index)
```
...
new DataOciDatabaseManagementManagedDatabasesAsmPropertyItemsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabasesAsmProperty.DataOciDatabaseManagementManagedDatabasesAsmPropertyItemsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabasesAsmProperty.DataOciDatabaseManagementManagedDatabasesAsmPropertyItemsOutputReference.resolve.parameter._context"></a>
...
```csharp
public DataOciDatabaseManagementManagedDatabasesAsmPropertyItems InternalValue { get; }
```
