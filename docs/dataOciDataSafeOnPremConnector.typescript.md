...
```typescript
import { dataOciDataSafeOnPremConnector } from 'rhizo-co-terraform-provider-oci'

new dataOciDataSafeOnPremConnector.DataOciDataSafeOnPremConnector(scope: Construct, id: string, config: DataOciDataSafeOnPremConnectorConfig)
```
...
dataOciDataSafeOnPremConnector.DataOciDataSafeOnPremConnector.isConstruct(x: any)
```
...
dataOciDataSafeOnPremConnector.DataOciDataSafeOnPremConnector.isTerraformElement(x: any)
```
...
dataOciDataSafeOnPremConnector.DataOciDataSafeOnPremConnector.isTerraformDataSource(x: any)
```
...
dataOciDataSafeOnPremConnector.DataOciDataSafeOnPremConnector.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDataSafeOnPremConnector.DataOciDataSafeOnPremConnector.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDataSafeOnPremConnector.DataOciDataSafeOnPremConnector.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDataSafeOnPremConnector.DataOciDataSafeOnPremConnector.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDataSafeOnPremConnector.DataOciDataSafeOnPremConnector.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDataSafeOnPremConnector.DataOciDataSafeOnPremConnector.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDataSafeOnPremConnector.DataOciDataSafeOnPremConnector.property.definedTags">definedTags</a></code> | <code>cdktf.StringMap</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDataSafeOnPremConnector.DataOciDataSafeOnPremConnector.property.freeformTags">freeformTags</a></code> | <code>cdktf.StringMap</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDataSafeOnPremConnector.DataOciDataSafeOnPremConnector.property.systemTags">systemTags</a></code> | <code>cdktf.StringMap</code> | *No description.* |
...
const dataOciDataSafeOnPremConnectorConfig: dataOciDataSafeOnPremConnector.DataOciDataSafeOnPremConnectorConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDataSafeOnPremConnector.DataOciDataSafeOnPremConnectorConfig.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDataSafeOnPremConnector.DataOciDataSafeOnPremConnectorConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDataSafeOnPremConnector.DataOciDataSafeOnPremConnectorConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDataSafeOnPremConnector.DataOciDataSafeOnPremConnectorConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDataSafeOnPremConnector.DataOciDataSafeOnPremConnectorConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
