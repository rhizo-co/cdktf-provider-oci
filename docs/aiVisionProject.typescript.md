...
```typescript
import { aiVisionProject } from 'rhizo-co-terraform-provider-oci'

new aiVisionProject.AiVisionProject(scope: Construct, id: string, config: AiVisionProjectConfig)
```
...
```typescript
public putTimeouts(value: AiVisionProjectTimeouts): void
```
...
aiVisionProject.AiVisionProject.isConstruct(x: any)
```
...
aiVisionProject.AiVisionProject.isTerraformElement(x: any)
```
...
aiVisionProject.AiVisionProject.isTerraformResource(x: any)
```
...
aiVisionProject.AiVisionProject.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProject.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProject.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProject.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProject.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProject.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProject.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProject.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProject.property.systemTags">systemTags</a></code> | <code>cdktf.StringMap</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProject.property.definedTagsInput">definedTagsInput</a></code> | <code>{[ key: string ]: string}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProject.property.freeformTagsInput">freeformTagsInput</a></code> | <code>{[ key: string ]: string}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProject.property.timeoutsInput">timeoutsInput</a></code> | <code>cdktf.IResolvable \| <a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProjectTimeouts">AiVisionProjectTimeouts</a></code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProject.property.definedTags">definedTags</a></code> | <code>{[ key: string ]: string}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProject.property.freeformTags">freeformTags</a></code> | <code>{[ key: string ]: string}</code> | *No description.* |
...
```typescript
public readonly timeouts: AiVisionProjectTimeoutsOutputReference;
```
...
```typescript
public readonly timeoutsInput: IResolvable | AiVisionProjectTimeouts;
```

- *Type:* cdktf.IResolvable | <a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProjectTimeouts">AiVisionProjectTimeouts</a>
...
const aiVisionProjectConfig: aiVisionProject.AiVisionProjectConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProjectConfig.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProjectConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProjectConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProjectConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProjectConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProjectConfig.property.definedTags">definedTags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/ai_vision_project#defined_tags AiVisionProject#defined_tags}. |
...
| <code><a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProjectConfig.property.freeformTags">freeformTags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/ai_vision_project#freeform_tags AiVisionProject#freeform_tags}. |
...
```typescript
public readonly timeouts: AiVisionProjectTimeouts;
```
...
const aiVisionProjectTimeouts: aiVisionProject.AiVisionProjectTimeouts = { ... }
```
...
new aiVisionProject.AiVisionProjectTimeoutsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProjectTimeoutsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProjectTimeoutsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktf.IResolvable \| <a href="#rhizo-co-terraform-provider-oci.aiVisionProject.AiVisionProjectTimeouts">AiVisionProjectTimeouts</a></code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | AiVisionProjectTimeouts;
```
