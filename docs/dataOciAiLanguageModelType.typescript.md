...
```typescript
import { dataOciAiLanguageModelType } from 'rhizo-co-terraform-provider-oci'

new dataOciAiLanguageModelType.DataOciAiLanguageModelType(scope: Construct, id: string, config: DataOciAiLanguageModelTypeConfig)
```
...
dataOciAiLanguageModelType.DataOciAiLanguageModelType.isConstruct(x: any)
```
...
dataOciAiLanguageModelType.DataOciAiLanguageModelType.isTerraformElement(x: any)
```
...
dataOciAiLanguageModelType.DataOciAiLanguageModelType.isTerraformDataSource(x: any)
```
...
dataOciAiLanguageModelType.DataOciAiLanguageModelType.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciAiLanguageModelType.DataOciAiLanguageModelType.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciAiLanguageModelType.DataOciAiLanguageModelType.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciAiLanguageModelType.DataOciAiLanguageModelType.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciAiLanguageModelType.DataOciAiLanguageModelType.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciAiLanguageModelType.DataOciAiLanguageModelType.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
const dataOciAiLanguageModelTypeConfig: dataOciAiLanguageModelType.DataOciAiLanguageModelTypeConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciAiLanguageModelType.DataOciAiLanguageModelTypeConfig.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciAiLanguageModelType.DataOciAiLanguageModelTypeConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciAiLanguageModelType.DataOciAiLanguageModelTypeConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciAiLanguageModelType.DataOciAiLanguageModelTypeConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciAiLanguageModelType.DataOciAiLanguageModelTypeConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
