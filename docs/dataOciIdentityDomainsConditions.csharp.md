...
new DataOciIdentityDomainsConditions(Construct Scope, string Id, DataOciIdentityDomainsConditionsConfig Config);
```
...
```csharp
private void ResetConditionCount()
```
...
DataOciIdentityDomainsConditions.IsConstruct(object X);
```
...
DataOciIdentityDomainsConditions.IsTerraformElement(object X);
```
...
DataOciIdentityDomainsConditions.IsTerraformDataSource(object X);
```
...
DataOciIdentityDomainsConditions.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditions.property.cdktfStack">CdktfStack</a></code> | <code>HashiCorp.Cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditions.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditions.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>HashiCorp.Cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditions.property.count">Count</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditions.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditions.property.lifecycle">Lifecycle</a></code> | <code>HashiCorp.Cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditions.property.provider">Provider</a></code> | <code>HashiCorp.Cdktf.TerraformProvider</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditions.property.itemsPerPage">ItemsPerPage</a></code> | <code>double</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditions.property.totalResults">TotalResults</a></code> | <code>double</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditions.property.conditionCountInput">ConditionCountInput</a></code> | <code>double</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditions.property.startIndexInput">StartIndexInput</a></code> | <code>double</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditions.property.conditionCount">ConditionCount</a></code> | <code>double</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditions.property.startIndex">StartIndex</a></code> | <code>double</code> | *No description.* |
...
```csharp
public DataOciIdentityDomainsConditionsConditionsList Conditions { get; }
```
...
```csharp
public double ConditionCountInput { get; }
```
...
```csharp
public string ConditionFilterInput { get; }
```
...
```csharp
public double ConditionCount { get; }
```
...
```csharp
public string ConditionFilter { get; }
```
...
new DataOciIdentityDomainsConditionsConditions {
...
new DataOciIdentityDomainsConditionsConditionsIdcsCreatedBy {
...
new DataOciIdentityDomainsConditionsConditionsIdcsLastModifiedBy {
...
new DataOciIdentityDomainsConditionsConditionsMeta {
...
new DataOciIdentityDomainsConditionsConditionsTags {
...
new DataOciIdentityDomainsConditionsConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConfig.property.connection">Connection</a></code> | <code>object</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConfig.property.count">Count</a></code> | <code>object</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConfig.property.dependsOn">DependsOn</a></code> | <code>HashiCorp.Cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConfig.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConfig.property.lifecycle">Lifecycle</a></code> | <code>HashiCorp.Cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConfig.property.provider">Provider</a></code> | <code>HashiCorp.Cdktf.TerraformProvider</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConfig.property.provisioners">Provisioners</a></code> | <code>object[]</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConfig.property.conditionCount">ConditionCount</a></code> | <code>double</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/data-sources/identity_domains_conditions#condition_count DataOciIdentityDomainsConditions#condition_count}. |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConfig.property.startIndex">StartIndex</a></code> | <code>double</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/data-sources/identity_domains_conditions#start_index DataOciIdentityDomainsConditions#start_index}. |
...
```csharp
public double ConditionCount { get; set; }
```
...
new DataOciIdentityDomainsConditionsConditionsIdcsCreatedByList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsIdcsCreatedByList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsIdcsCreatedByList.resolve.parameter._context"></a>
...
```csharp
private DataOciIdentityDomainsConditionsConditionsIdcsCreatedByOutputReference Get(double Index)
```
...
new DataOciIdentityDomainsConditionsConditionsIdcsCreatedByOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsIdcsCreatedByOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsIdcsCreatedByOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsIdcsCreatedByOutputReference.resolve.parameter._context"></a>
...
```csharp
public DataOciIdentityDomainsConditionsConditionsIdcsCreatedBy InternalValue { get; }
```
...
new DataOciIdentityDomainsConditionsConditionsIdcsLastModifiedByList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsIdcsLastModifiedByList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsIdcsLastModifiedByList.resolve.parameter._context"></a>
...
```csharp
private DataOciIdentityDomainsConditionsConditionsIdcsLastModifiedByOutputReference Get(double Index)
```
...
new DataOciIdentityDomainsConditionsConditionsIdcsLastModifiedByOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsIdcsLastModifiedByOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsIdcsLastModifiedByOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsIdcsLastModifiedByOutputReference.resolve.parameter._context"></a>
...
```csharp
public DataOciIdentityDomainsConditionsConditionsIdcsLastModifiedBy InternalValue { get; }
```
...
new DataOciIdentityDomainsConditionsConditionsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsList.resolve.parameter._context"></a>
...
```csharp
private DataOciIdentityDomainsConditionsConditionsOutputReference Get(double Index)
```
...
new DataOciIdentityDomainsConditionsConditionsMetaList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsMetaList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsMetaList.resolve.parameter._context"></a>
...
```csharp
private DataOciIdentityDomainsConditionsConditionsMetaOutputReference Get(double Index)
```
...
new DataOciIdentityDomainsConditionsConditionsMetaOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsMetaOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsMetaOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsMetaOutputReference.resolve.parameter._context"></a>
...
```csharp
public DataOciIdentityDomainsConditionsConditionsMeta InternalValue { get; }
```
...
new DataOciIdentityDomainsConditionsConditionsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsOutputReference.resolve.parameter._context"></a>
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsOutputReference.property.deleteInProgress">DeleteInProgress</a></code> | <code>HashiCorp.Cdktf.IResolvable</code> | *No description.* |
...
```csharp
public DataOciIdentityDomainsConditionsConditionsIdcsCreatedByList IdcsCreatedBy { get; }
```
...
```csharp
public DataOciIdentityDomainsConditionsConditionsIdcsLastModifiedByList IdcsLastModifiedBy { get; }
```
...
```csharp
public DataOciIdentityDomainsConditionsConditionsMetaList Meta { get; }
```
...
```csharp
public DataOciIdentityDomainsConditionsConditionsTagsList Tags { get; }
```
...
```csharp
public DataOciIdentityDomainsConditionsConditions InternalValue { get; }
```
...
new DataOciIdentityDomainsConditionsConditionsTagsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsTagsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsTagsList.resolve.parameter._context"></a>
...
```csharp
private DataOciIdentityDomainsConditionsConditionsTagsOutputReference Get(double Index)
```
...
new DataOciIdentityDomainsConditionsConditionsTagsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsTagsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsTagsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="rhizo-co-terraform-provider-oci.dataOciIdentityDomainsConditions.DataOciIdentityDomainsConditionsConditionsTagsOutputReference.resolve.parameter._context"></a>
...
```csharp
public DataOciIdentityDomainsConditionsConditionsTags InternalValue { get; }
```
