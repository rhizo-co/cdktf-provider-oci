...
```typescript
import { dataOciCloudGuardSecurityZone } from 'rhizo-co-terraform-provider-oci'

new dataOciCloudGuardSecurityZone.DataOciCloudGuardSecurityZone(scope: Construct, id: string, config: DataOciCloudGuardSecurityZoneConfig)
```
...
dataOciCloudGuardSecurityZone.DataOciCloudGuardSecurityZone.isConstruct(x: any)
```
...
dataOciCloudGuardSecurityZone.DataOciCloudGuardSecurityZone.isTerraformElement(x: any)
```
...
dataOciCloudGuardSecurityZone.DataOciCloudGuardSecurityZone.isTerraformDataSource(x: any)
```
...
dataOciCloudGuardSecurityZone.DataOciCloudGuardSecurityZone.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCloudGuardSecurityZone.DataOciCloudGuardSecurityZone.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCloudGuardSecurityZone.DataOciCloudGuardSecurityZone.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCloudGuardSecurityZone.DataOciCloudGuardSecurityZone.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCloudGuardSecurityZone.DataOciCloudGuardSecurityZone.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCloudGuardSecurityZone.DataOciCloudGuardSecurityZone.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCloudGuardSecurityZone.DataOciCloudGuardSecurityZone.property.definedTags">definedTags</a></code> | <code>cdktf.StringMap</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCloudGuardSecurityZone.DataOciCloudGuardSecurityZone.property.freeformTags">freeformTags</a></code> | <code>cdktf.StringMap</code> | *No description.* |
...
```typescript
public readonly securityZoneIdInput: string;
```
...
const dataOciCloudGuardSecurityZoneConfig: dataOciCloudGuardSecurityZone.DataOciCloudGuardSecurityZoneConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCloudGuardSecurityZone.DataOciCloudGuardSecurityZoneConfig.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCloudGuardSecurityZone.DataOciCloudGuardSecurityZoneConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCloudGuardSecurityZone.DataOciCloudGuardSecurityZoneConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCloudGuardSecurityZone.DataOciCloudGuardSecurityZoneConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCloudGuardSecurityZone.DataOciCloudGuardSecurityZoneConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
