...
```typescript
import { databaseDbNodeConsoleHistory } from 'rhizo-co-terraform-provider-oci'

new databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory(scope: Construct, id: string, config: DatabaseDbNodeConsoleHistoryConfig)
```
...
```typescript
public putTimeouts(value: DatabaseDbNodeConsoleHistoryTimeouts): void
```
...
databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.isConstruct(x: any)
```
...
databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.isTerraformElement(x: any)
```
...
databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.isTerraformResource(x: any)
```
...
databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.definedTagsInput">definedTagsInput</a></code> | <code>{[ key: string ]: string}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.freeformTagsInput">freeformTagsInput</a></code> | <code>{[ key: string ]: string}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.definedTags">definedTags</a></code> | <code>{[ key: string ]: string}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistory.property.freeformTags">freeformTags</a></code> | <code>{[ key: string ]: string}</code> | *No description.* |
...
```typescript
public readonly timeouts: DatabaseDbNodeConsoleHistoryTimeoutsOutputReference;
```
...
```typescript
public readonly timeoutsInput: IResolvable | DatabaseDbNodeConsoleHistoryTimeouts;
```

- *Type:* cdktf.IResolvable | <a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryTimeouts">DatabaseDbNodeConsoleHistoryTimeouts</a>
...
const databaseDbNodeConsoleHistoryConfig: databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryConfig.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryConfig.property.definedTags">definedTags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/database_db_node_console_history#defined_tags DatabaseDbNodeConsoleHistory#defined_tags}. |
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryConfig.property.freeformTags">freeformTags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/database_db_node_console_history#freeform_tags DatabaseDbNodeConsoleHistory#freeform_tags}. |
...
```typescript
public readonly timeouts: DatabaseDbNodeConsoleHistoryTimeouts;
```
...
const databaseDbNodeConsoleHistoryTimeouts: databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryTimeouts = { ... }
```
...
new databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryTimeoutsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryTimeoutsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryTimeoutsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktf.IResolvable \| <a href="#rhizo-co-terraform-provider-oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryTimeouts">DatabaseDbNodeConsoleHistoryTimeouts</a></code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | DatabaseDbNodeConsoleHistoryTimeouts;
```
