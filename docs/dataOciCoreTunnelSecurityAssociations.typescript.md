...
```typescript
public readonly cpeSubnet: string;
```
...
```typescript
public readonly oracleSubnet: string;
```
...
```typescript
public readonly tunnelSaErrorInfo: string;
```
...
```typescript
public readonly tunnelSaStatus: string;
```
...
```typescript
public readonly internalValue: DataOciCoreTunnelSecurityAssociationsTunnelSecurityAssociations;
```
