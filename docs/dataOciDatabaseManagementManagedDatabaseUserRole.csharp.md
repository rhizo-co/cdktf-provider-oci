...
new DataOciDatabaseManagementManagedDatabaseUserRole(Construct Scope, string Id, DataOciDatabaseManagementManagedDatabaseUserRoleConfig Config);
```
...
DataOciDatabaseManagementManagedDatabaseUserRole.IsConstruct(object X);
```
...
DataOciDatabaseManagementManagedDatabaseUserRole.IsTerraformElement(object X);
```
...
DataOciDatabaseManagementManagedDatabaseUserRole.IsTerraformDataSource(object X);
```
...
DataOciDatabaseManagementManagedDatabaseUserRole.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabaseUserRole.DataOciDatabaseManagementManagedDatabaseUserRole.property.cdktfStack">CdktfStack</a></code> | <code>HashiCorp.Cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabaseUserRole.DataOciDatabaseManagementManagedDatabaseUserRole.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabaseUserRole.DataOciDatabaseManagementManagedDatabaseUserRole.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>HashiCorp.Cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabaseUserRole.DataOciDatabaseManagementManagedDatabaseUserRole.property.count">Count</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabaseUserRole.DataOciDatabaseManagementManagedDatabaseUserRole.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabaseUserRole.DataOciDatabaseManagementManagedDatabaseUserRole.property.lifecycle">Lifecycle</a></code> | <code>HashiCorp.Cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabaseUserRole.DataOciDatabaseManagementManagedDatabaseUserRole.property.provider">Provider</a></code> | <code>HashiCorp.Cdktf.TerraformProvider</code> | *No description.* |
...
```csharp
public DataOciDatabaseManagementManagedDatabaseUserRoleItemsList Items { get; }
```
...
new DataOciDatabaseManagementManagedDatabaseUserRoleConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabaseUserRole.DataOciDatabaseManagementManagedDatabaseUserRoleConfig.property.connection">Connection</a></code> | <code>object</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabaseUserRole.DataOciDatabaseManagementManagedDatabaseUserRoleConfig.property.count">Count</a></code> | <code>object</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabaseUserRole.DataOciDatabaseManagementManagedDatabaseUserRoleConfig.property.dependsOn">DependsOn</a></code> | <code>HashiCorp.Cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabaseUserRole.DataOciDatabaseManagementManagedDatabaseUserRoleConfig.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabaseUserRole.DataOciDatabaseManagementManagedDatabaseUserRoleConfig.property.lifecycle">Lifecycle</a></code> | <code>HashiCorp.Cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabaseUserRole.DataOciDatabaseManagementManagedDatabaseUserRoleConfig.property.provider">Provider</a></code> | <code>HashiCorp.Cdktf.TerraformProvider</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabaseUserRole.DataOciDatabaseManagementManagedDatabaseUserRoleConfig.property.provisioners">Provisioners</a></code> | <code>object[]</code> | *No description.* |
...
new DataOciDatabaseManagementManagedDatabaseUserRoleItems {
...
new DataOciDatabaseManagementManagedDatabaseUserRoleItemsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabaseUserRole.DataOciDatabaseManagementManagedDatabaseUserRoleItemsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabaseUserRole.DataOciDatabaseManagementManagedDatabaseUserRoleItemsList.resolve.parameter._context"></a>
...
```csharp
private DataOciDatabaseManagementManagedDatabaseUserRoleItemsOutputReference Get(double Index)
```
...
new DataOciDatabaseManagementManagedDatabaseUserRoleItemsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabaseUserRole.DataOciDatabaseManagementManagedDatabaseUserRoleItemsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabaseUserRole.DataOciDatabaseManagementManagedDatabaseUserRoleItemsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="rhizo-co-terraform-provider-oci.dataOciDatabaseManagementManagedDatabaseUserRole.DataOciDatabaseManagementManagedDatabaseUserRoleItemsOutputReference.resolve.parameter._context"></a>
...
```csharp
public DataOciDatabaseManagementManagedDatabaseUserRoleItems InternalValue { get; }
```
