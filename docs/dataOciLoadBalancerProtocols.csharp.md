...
new DataOciLoadBalancerProtocols(Construct Scope, string Id, DataOciLoadBalancerProtocolsConfig Config);
```
...
DataOciLoadBalancerProtocols.IsConstruct(object X);
```
...
DataOciLoadBalancerProtocols.IsTerraformElement(object X);
```
...
DataOciLoadBalancerProtocols.IsTerraformDataSource(object X);
```
...
DataOciLoadBalancerProtocols.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocols.property.cdktfStack">CdktfStack</a></code> | <code>HashiCorp.Cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocols.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocols.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>HashiCorp.Cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocols.property.count">Count</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocols.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocols.property.lifecycle">Lifecycle</a></code> | <code>HashiCorp.Cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocols.property.provider">Provider</a></code> | <code>HashiCorp.Cdktf.TerraformProvider</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocols.property.filterInput">FilterInput</a></code> | <code>object</code> | *No description.* |
...
```csharp
public DataOciLoadBalancerProtocolsFilterList Filter { get; }
```
...
```csharp
public DataOciLoadBalancerProtocolsProtocolsList Protocols { get; }
```
...
new DataOciLoadBalancerProtocolsConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsConfig.property.connection">Connection</a></code> | <code>object</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsConfig.property.count">Count</a></code> | <code>object</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsConfig.property.dependsOn">DependsOn</a></code> | <code>HashiCorp.Cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsConfig.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsConfig.property.lifecycle">Lifecycle</a></code> | <code>HashiCorp.Cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsConfig.property.provider">Provider</a></code> | <code>HashiCorp.Cdktf.TerraformProvider</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsConfig.property.provisioners">Provisioners</a></code> | <code>object[]</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsConfig.property.filter">Filter</a></code> | <code>object</code> | filter block. |
...
new DataOciLoadBalancerProtocolsFilter {
    string Name,
    string[] Values,
    object Regex = null
};
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsFilter.property.regex">Regex</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/data-sources/load_balancer_protocols#regex DataOciLoadBalancerProtocols#regex}. |
...
new DataOciLoadBalancerProtocolsProtocols {
...
new DataOciLoadBalancerProtocolsFilterList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsFilterList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsFilterList.resolve.parameter._context"></a>
...
```csharp
private DataOciLoadBalancerProtocolsFilterOutputReference Get(double Index)
```
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsFilterList.property.internalValue">InternalValue</a></code> | <code>object</code> | *No description.* |
...
new DataOciLoadBalancerProtocolsFilterOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsFilterOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsFilterOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsFilterOutputReference.resolve.parameter._context"></a>
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsFilterOutputReference.property.regexInput">RegexInput</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsFilterOutputReference.property.regex">Regex</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsFilterOutputReference.property.internalValue">InternalValue</a></code> | <code>object</code> | *No description.* |
...
new DataOciLoadBalancerProtocolsProtocolsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsProtocolsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsProtocolsList.resolve.parameter._context"></a>
...
```csharp
private DataOciLoadBalancerProtocolsProtocolsOutputReference Get(double Index)
```
...
new DataOciLoadBalancerProtocolsProtocolsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsProtocolsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsProtocolsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="rhizo-co-terraform-provider-oci.dataOciLoadBalancerProtocols.DataOciLoadBalancerProtocolsProtocolsOutputReference.resolve.parameter._context"></a>
...
```csharp
public DataOciLoadBalancerProtocolsProtocols InternalValue { get; }
```
