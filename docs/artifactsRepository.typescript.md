...
```typescript
import { artifactsRepository } from 'rhizo-co-terraform-provider-oci'

new artifactsRepository.ArtifactsRepository(scope: Construct, id: string, config: ArtifactsRepositoryConfig)
```
...
```typescript
public putTimeouts(value: ArtifactsRepositoryTimeouts): void
```
...
artifactsRepository.ArtifactsRepository.isConstruct(x: any)
```
...
artifactsRepository.ArtifactsRepository.isTerraformElement(x: any)
```
...
artifactsRepository.ArtifactsRepository.isTerraformResource(x: any)
```
...
artifactsRepository.ArtifactsRepository.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepository.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepository.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepository.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepository.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepository.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepository.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepository.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepository.property.definedTagsInput">definedTagsInput</a></code> | <code>{[ key: string ]: string}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepository.property.freeformTagsInput">freeformTagsInput</a></code> | <code>{[ key: string ]: string}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepository.property.isImmutableInput">isImmutableInput</a></code> | <code>boolean \| cdktf.IResolvable</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepository.property.timeoutsInput">timeoutsInput</a></code> | <code>cdktf.IResolvable \| <a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepositoryTimeouts">ArtifactsRepositoryTimeouts</a></code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepository.property.definedTags">definedTags</a></code> | <code>{[ key: string ]: string}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepository.property.freeformTags">freeformTags</a></code> | <code>{[ key: string ]: string}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepository.property.isImmutable">isImmutable</a></code> | <code>boolean \| cdktf.IResolvable</code> | *No description.* |
...
```typescript
public readonly timeouts: ArtifactsRepositoryTimeoutsOutputReference;
```
...
```typescript
public readonly timeoutsInput: IResolvable | ArtifactsRepositoryTimeouts;
```

- *Type:* cdktf.IResolvable | <a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepositoryTimeouts">ArtifactsRepositoryTimeouts</a>
...
const artifactsRepositoryConfig: artifactsRepository.ArtifactsRepositoryConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepositoryConfig.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepositoryConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepositoryConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepositoryConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepositoryConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepositoryConfig.property.isImmutable">isImmutable</a></code> | <code>boolean \| cdktf.IResolvable</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/artifacts_repository#is_immutable ArtifactsRepository#is_immutable}. |
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepositoryConfig.property.repositoryType">repositoryType</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/artifacts_repository#repository_type ArtifactsRepository#repository_type}. |
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepositoryConfig.property.definedTags">definedTags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/artifacts_repository#defined_tags ArtifactsRepository#defined_tags}. |
...
```typescript
public readonly timeouts: ArtifactsRepositoryTimeouts;
```
...
const artifactsRepositoryTimeouts: artifactsRepository.ArtifactsRepositoryTimeouts = { ... }
```
...
new artifactsRepository.ArtifactsRepositoryTimeoutsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.artifactsRepository.ArtifactsRepositoryTimeoutsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: IResolvable | ArtifactsRepositoryTimeouts;
```
