...
```typescript
import { dataOciIdentityPolicies } from 'rhizo-co-terraform-provider-oci'

new dataOciIdentityPolicies.DataOciIdentityPolicies(scope: Construct, id: string, config: DataOciIdentityPoliciesConfig)
```
...
```typescript
public putFilter(value: IResolvable | DataOciIdentityPoliciesFilter[]): void
```
...
- *Type:* cdktf.IResolvable | <a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesFilter">DataOciIdentityPoliciesFilter</a>[]
...
dataOciIdentityPolicies.DataOciIdentityPolicies.isConstruct(x: any)
```
...
dataOciIdentityPolicies.DataOciIdentityPolicies.isTerraformElement(x: any)
```
...
dataOciIdentityPolicies.DataOciIdentityPolicies.isTerraformDataSource(x: any)
```
...
dataOciIdentityPolicies.DataOciIdentityPolicies.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPolicies.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPolicies.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPolicies.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPolicies.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPolicies.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPolicies.property.filterInput">filterInput</a></code> | <code>cdktf.IResolvable \| <a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesFilter">DataOciIdentityPoliciesFilter</a>[]</code> | *No description.* |
...
```typescript
public readonly filter: DataOciIdentityPoliciesFilterList;
```
...
```typescript
public readonly policies: DataOciIdentityPoliciesPoliciesList;
```
...
```typescript
public readonly filterInput: IResolvable | DataOciIdentityPoliciesFilter[];
```
...
const dataOciIdentityPoliciesConfig: dataOciIdentityPolicies.DataOciIdentityPoliciesConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesConfig.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesConfig.property.filter">filter</a></code> | <code>cdktf.IResolvable \| <a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesFilter">DataOciIdentityPoliciesFilter</a>[]</code> | filter block. |
...
```typescript
public readonly filter: IResolvable | DataOciIdentityPoliciesFilter[];
```
...
const dataOciIdentityPoliciesFilter: dataOciIdentityPolicies.DataOciIdentityPoliciesFilter = { ... }
```
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesFilter.property.regex">regex</a></code> | <code>boolean \| cdktf.IResolvable</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/data-sources/identity_policies#regex DataOciIdentityPolicies#regex}. |
...
const dataOciIdentityPoliciesPolicies: dataOciIdentityPolicies.DataOciIdentityPoliciesPolicies = { ... }
```
...
new dataOciIdentityPolicies.DataOciIdentityPoliciesFilterList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesFilterList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesFilterList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public readonly internalValue: IResolvable | DataOciIdentityPoliciesFilter[];
```
...
new dataOciIdentityPolicies.DataOciIdentityPoliciesFilterOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesFilterOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesFilterOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesFilterOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesFilterOutputReference.property.regexInput">regexInput</a></code> | <code>boolean \| cdktf.IResolvable</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesFilterOutputReference.property.regex">regex</a></code> | <code>boolean \| cdktf.IResolvable</code> | *No description.* |
...
new dataOciIdentityPolicies.DataOciIdentityPoliciesPoliciesList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesPoliciesList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesPoliciesList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
new dataOciIdentityPolicies.DataOciIdentityPoliciesPoliciesOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesPoliciesOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesPoliciesOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesPoliciesOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesPoliciesOutputReference.property.definedTags">definedTags</a></code> | <code>cdktf.StringMap</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciIdentityPolicies.DataOciIdentityPoliciesPoliciesOutputReference.property.freeformTags">freeformTags</a></code> | <code>cdktf.StringMap</code> | *No description.* |
...
```typescript
public readonly internalValue: DataOciIdentityPoliciesPolicies;
```
