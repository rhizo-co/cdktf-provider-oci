...
```typescript
import { identityUiPassword } from 'rhizo-co-terraform-provider-oci'

new identityUiPassword.IdentityUiPassword(scope: Construct, id: string, config: IdentityUiPasswordConfig)
```
...
```typescript
public putTimeouts(value: IdentityUiPasswordTimeouts): void
```
...
identityUiPassword.IdentityUiPassword.isConstruct(x: any)
```
...
identityUiPassword.IdentityUiPassword.isTerraformElement(x: any)
```
...
identityUiPassword.IdentityUiPassword.isTerraformResource(x: any)
```
...
identityUiPassword.IdentityUiPassword.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#rhizo-co-terraform-provider-oci.identityUiPassword.IdentityUiPassword.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.identityUiPassword.IdentityUiPassword.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.identityUiPassword.IdentityUiPassword.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.identityUiPassword.IdentityUiPassword.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.identityUiPassword.IdentityUiPassword.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.identityUiPassword.IdentityUiPassword.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.identityUiPassword.IdentityUiPassword.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.identityUiPassword.IdentityUiPassword.property.timeoutsInput">timeoutsInput</a></code> | <code>cdktf.IResolvable \| <a href="#rhizo-co-terraform-provider-oci.identityUiPassword.IdentityUiPasswordTimeouts">IdentityUiPasswordTimeouts</a></code> | *No description.* |
...
```typescript
public readonly timeouts: IdentityUiPasswordTimeoutsOutputReference;
```
...
```typescript
public readonly timeoutsInput: IResolvable | IdentityUiPasswordTimeouts;
```

- *Type:* cdktf.IResolvable | <a href="#rhizo-co-terraform-provider-oci.identityUiPassword.IdentityUiPasswordTimeouts">IdentityUiPasswordTimeouts</a>
...
const identityUiPasswordConfig: identityUiPassword.IdentityUiPasswordConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.identityUiPassword.IdentityUiPasswordConfig.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.identityUiPassword.IdentityUiPasswordConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.identityUiPassword.IdentityUiPasswordConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.identityUiPassword.IdentityUiPasswordConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.identityUiPassword.IdentityUiPasswordConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly timeouts: IdentityUiPasswordTimeouts;
```
...
const identityUiPasswordTimeouts: identityUiPassword.IdentityUiPasswordTimeouts = { ... }
```
...
new identityUiPassword.IdentityUiPasswordTimeoutsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.identityUiPassword.IdentityUiPasswordTimeoutsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: IResolvable | IdentityUiPasswordTimeouts;
```
