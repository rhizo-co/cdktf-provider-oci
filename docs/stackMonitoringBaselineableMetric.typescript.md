...
```typescript
import { stackMonitoringBaselineableMetric } from 'rhizo-co-terraform-provider-oci'

new stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetric(scope: Construct, id: string, config: StackMonitoringBaselineableMetricConfig)
```
...
```typescript
public putTimeouts(value: StackMonitoringBaselineableMetricTimeouts): void
```
...
stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetric.isConstruct(x: any)
```
...
stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetric.isTerraformElement(x: any)
```
...
stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetric.isTerraformResource(x: any)
```
...
stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetric.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#rhizo-co-terraform-provider-oci.stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetric.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetric.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetric.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetric.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetric.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetric.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetric.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetric.property.definedTags">definedTags</a></code> | <code>cdktf.StringMap</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetric.property.freeformTags">freeformTags</a></code> | <code>cdktf.StringMap</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetric.property.isOutOfBox">isOutOfBox</a></code> | <code>cdktf.IResolvable</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetric.property.systemTags">systemTags</a></code> | <code>cdktf.StringMap</code> | *No description.* |
...
```typescript
public readonly timeouts: StackMonitoringBaselineableMetricTimeoutsOutputReference;
```
...
```typescript
public readonly timeoutsInput: IResolvable | StackMonitoringBaselineableMetricTimeouts;
```

- *Type:* cdktf.IResolvable | <a href="#rhizo-co-terraform-provider-oci.stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetricTimeouts">StackMonitoringBaselineableMetricTimeouts</a>
...
const stackMonitoringBaselineableMetricConfig: stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetricConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetricConfig.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetricConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetricConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetricConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetricConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly timeouts: StackMonitoringBaselineableMetricTimeouts;
```
...
const stackMonitoringBaselineableMetricTimeouts: stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetricTimeouts = { ... }
```
...
new stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetricTimeoutsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetricTimeoutsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#rhizo-co-terraform-provider-oci.stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetricTimeoutsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktf.IResolvable \| <a href="#rhizo-co-terraform-provider-oci.stackMonitoringBaselineableMetric.StackMonitoringBaselineableMetricTimeouts">StackMonitoringBaselineableMetricTimeouts</a></code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | StackMonitoringBaselineableMetricTimeouts;
```
