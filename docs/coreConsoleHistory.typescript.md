...
```typescript
import { coreConsoleHistory } from 'rhizo-co-terraform-provider-oci'

new coreConsoleHistory.CoreConsoleHistory(scope: Construct, id: string, config: CoreConsoleHistoryConfig)
```
...
```typescript
public putTimeouts(value: CoreConsoleHistoryTimeouts): void
```
...
coreConsoleHistory.CoreConsoleHistory.isConstruct(x: any)
```
...
coreConsoleHistory.CoreConsoleHistory.isTerraformElement(x: any)
```
...
coreConsoleHistory.CoreConsoleHistory.isTerraformResource(x: any)
```
...
coreConsoleHistory.CoreConsoleHistory.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistory.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistory.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistory.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistory.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistory.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistory.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistory.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistory.property.definedTagsInput">definedTagsInput</a></code> | <code>{[ key: string ]: string}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistory.property.freeformTagsInput">freeformTagsInput</a></code> | <code>{[ key: string ]: string}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistory.property.timeoutsInput">timeoutsInput</a></code> | <code>cdktf.IResolvable \| <a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistoryTimeouts">CoreConsoleHistoryTimeouts</a></code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistory.property.definedTags">definedTags</a></code> | <code>{[ key: string ]: string}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistory.property.freeformTags">freeformTags</a></code> | <code>{[ key: string ]: string}</code> | *No description.* |
...
```typescript
public readonly timeouts: CoreConsoleHistoryTimeoutsOutputReference;
```
...
```typescript
public readonly timeoutsInput: IResolvable | CoreConsoleHistoryTimeouts;
```

- *Type:* cdktf.IResolvable | <a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistoryTimeouts">CoreConsoleHistoryTimeouts</a>
...
const coreConsoleHistoryConfig: coreConsoleHistory.CoreConsoleHistoryConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistoryConfig.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistoryConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistoryConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistoryConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistoryConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistoryConfig.property.definedTags">definedTags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/core_console_history#defined_tags CoreConsoleHistory#defined_tags}. |
...
| <code><a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistoryConfig.property.freeformTags">freeformTags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/core_console_history#freeform_tags CoreConsoleHistory#freeform_tags}. |
...
```typescript
public readonly timeouts: CoreConsoleHistoryTimeouts;
```
...
const coreConsoleHistoryTimeouts: coreConsoleHistory.CoreConsoleHistoryTimeouts = { ... }
```
...
new coreConsoleHistory.CoreConsoleHistoryTimeoutsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistoryTimeoutsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistoryTimeoutsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktf.IResolvable \| <a href="#rhizo-co-terraform-provider-oci.coreConsoleHistory.CoreConsoleHistoryTimeouts">CoreConsoleHistoryTimeouts</a></code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | CoreConsoleHistoryTimeouts;
```
