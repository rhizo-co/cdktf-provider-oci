...
```typescript
import { dataOciCertificatesManagementCaBundle } from 'rhizo-co-terraform-provider-oci'

new dataOciCertificatesManagementCaBundle.DataOciCertificatesManagementCaBundle(scope: Construct, id: string, config: DataOciCertificatesManagementCaBundleConfig)
```
...
dataOciCertificatesManagementCaBundle.DataOciCertificatesManagementCaBundle.isConstruct(x: any)
```
...
dataOciCertificatesManagementCaBundle.DataOciCertificatesManagementCaBundle.isTerraformElement(x: any)
```
...
dataOciCertificatesManagementCaBundle.DataOciCertificatesManagementCaBundle.isTerraformDataSource(x: any)
```
...
dataOciCertificatesManagementCaBundle.DataOciCertificatesManagementCaBundle.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCertificatesManagementCaBundle.DataOciCertificatesManagementCaBundle.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCertificatesManagementCaBundle.DataOciCertificatesManagementCaBundle.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCertificatesManagementCaBundle.DataOciCertificatesManagementCaBundle.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCertificatesManagementCaBundle.DataOciCertificatesManagementCaBundle.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCertificatesManagementCaBundle.DataOciCertificatesManagementCaBundle.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCertificatesManagementCaBundle.DataOciCertificatesManagementCaBundle.property.definedTags">definedTags</a></code> | <code>cdktf.StringMap</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCertificatesManagementCaBundle.DataOciCertificatesManagementCaBundle.property.freeformTags">freeformTags</a></code> | <code>cdktf.StringMap</code> | *No description.* |
...
const dataOciCertificatesManagementCaBundleConfig: dataOciCertificatesManagementCaBundle.DataOciCertificatesManagementCaBundleConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCertificatesManagementCaBundle.DataOciCertificatesManagementCaBundleConfig.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCertificatesManagementCaBundle.DataOciCertificatesManagementCaBundleConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCertificatesManagementCaBundle.DataOciCertificatesManagementCaBundleConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCertificatesManagementCaBundle.DataOciCertificatesManagementCaBundleConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#rhizo-co-terraform-provider-oci.dataOciCertificatesManagementCaBundle.DataOciCertificatesManagementCaBundleConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
