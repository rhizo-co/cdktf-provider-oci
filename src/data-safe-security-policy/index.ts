// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/data_safe_security_policy
...
export class DataSafeSecurityPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataSafeSecurityPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/data_safe_security_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/data_safe_security_policy oci_data_safe_security_policy} Resource
  *
  * @param scope The scope in which to define this construct
