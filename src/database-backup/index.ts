// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/database_backup
...
export class DatabaseBackup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatabaseBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/database_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/database_backup oci_database_backup} Resource
  *
  * @param scope The scope in which to define this construct
