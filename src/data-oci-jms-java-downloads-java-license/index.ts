...
export class DataOciJmsJavaDownloadsJavaLicense extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciJmsJavaDownloadsJavaLicense that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/data-sources/jms_java_downloads_java_license#import import section} in the documentation of this resource for the id to use
