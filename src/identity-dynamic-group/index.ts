// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/identity_dynamic_group
...
export class IdentityDynamicGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityDynamicGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/identity_dynamic_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/identity_dynamic_group oci_identity_dynamic_group} Resource
  *
  * @param scope The scope in which to define this construct
