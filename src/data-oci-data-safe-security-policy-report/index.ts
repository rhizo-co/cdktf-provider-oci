...
export class DataOciDataSafeSecurityPolicyReport extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDataSafeSecurityPolicyReport that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/data-sources/data_safe_security_policy_report#import import section} in the documentation of this resource for the id to use
