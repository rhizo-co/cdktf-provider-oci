// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/ai_document_project
...
export class AiDocumentProject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AiDocumentProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/ai_document_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/ai_document_project oci_ai_document_project} Resource
  *
  * @param scope The scope in which to define this construct
