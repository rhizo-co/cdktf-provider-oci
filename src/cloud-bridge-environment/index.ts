// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/cloud_bridge_environment
...
export class CloudBridgeEnvironment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudBridgeEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/cloud_bridge_environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/cloud_bridge_environment oci_cloud_bridge_environment} Resource
  *
  * @param scope The scope in which to define this construct
