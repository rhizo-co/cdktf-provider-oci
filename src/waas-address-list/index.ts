// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/waas_address_list
...
export class WaasAddressList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WaasAddressList that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/waas_address_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/waas_address_list oci_waas_address_list} Resource
  *
  * @param scope The scope in which to define this construct
