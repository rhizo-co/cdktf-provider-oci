// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/database_db_node_console_connection
...
export class DatabaseDbNodeConsoleConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatabaseDbNodeConsoleConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/database_db_node_console_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/database_db_node_console_connection oci_database_db_node_console_connection} Resource
  *
  * @param scope The scope in which to define this construct
