// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/waas_custom_protection_rule
...
export class WaasCustomProtectionRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WaasCustomProtectionRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/waas_custom_protection_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/waas_custom_protection_rule oci_waas_custom_protection_rule} Resource
  *
  * @param scope The scope in which to define this construct
