...
export class NetworkFirewallNetworkFirewallPolicyServiceList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkFirewallNetworkFirewallPolicyServiceList that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/network_firewall_network_firewall_policy_service_list#import import section} in the documentation of this resource for the id to use
