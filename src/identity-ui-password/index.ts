// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/identity_ui_password
...
export class IdentityUiPassword extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityUiPassword that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/identity_ui_password#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/identity_ui_password oci_identity_ui_password} Resource
  *
  * @param scope The scope in which to define this construct
