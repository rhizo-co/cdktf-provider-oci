...
export class DataOciCoreInstanceMaintenanceReboot extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCoreInstanceMaintenanceReboot that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/data-sources/core_instance_maintenance_reboot#import import section} in the documentation of this resource for the id to use
