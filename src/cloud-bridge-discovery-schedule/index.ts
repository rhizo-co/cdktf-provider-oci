// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/cloud_bridge_discovery_schedule
...
export class CloudBridgeDiscoverySchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudBridgeDiscoverySchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/cloud_bridge_discovery_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/cloud_bridge_discovery_schedule oci_cloud_bridge_discovery_schedule} Resource
  *
  * @param scope The scope in which to define this construct
