// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/email_sender
...
export class EmailSender extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EmailSender that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/email_sender#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/email_sender oci_email_sender} Resource
  *
  * @param scope The scope in which to define this construct
