// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/core_cpe
...
export class CoreCpe extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CoreCpe that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/core_cpe#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/core_cpe oci_core_cpe} Resource
  *
  * @param scope The scope in which to define this construct
