// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/adm_knowledge_base
...
export class AdmKnowledgeBase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AdmKnowledgeBase that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/adm_knowledge_base#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/adm_knowledge_base oci_adm_knowledge_base} Resource
  *
  * @param scope The scope in which to define this construct
