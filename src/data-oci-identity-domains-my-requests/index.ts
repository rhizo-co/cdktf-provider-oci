...
export class DataOciIdentityDomainsMyRequests extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciIdentityDomainsMyRequests that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/data-sources/identity_domains_my_requests#import import section} in the documentation of this resource for the id to use
