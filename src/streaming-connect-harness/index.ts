// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/streaming_connect_harness
...
export class StreamingConnectHarness extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StreamingConnectHarness that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/streaming_connect_harness#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/streaming_connect_harness oci_streaming_connect_harness} Resource
  *
  * @param scope The scope in which to define this construct
