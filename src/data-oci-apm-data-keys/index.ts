// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/data-sources/apm_data_keys
...
export class DataOciApmDataKeys extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciApmDataKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/data-sources/apm_data_keys#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/data-sources/apm_data_keys oci_apm_data_keys} Data Source
  *
  * @param scope The scope in which to define this construct
