// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/ai_vision_project
...
export class AiVisionProject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AiVisionProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/ai_vision_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/ai_vision_project oci_ai_vision_project} Resource
  *
  * @param scope The scope in which to define this construct
