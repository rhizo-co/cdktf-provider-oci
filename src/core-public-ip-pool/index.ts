// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/core_public_ip_pool
...
export class CorePublicIpPool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CorePublicIpPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/core_public_ip_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/core_public_ip_pool oci_core_public_ip_pool} Resource
  *
  * @param scope The scope in which to define this construct
