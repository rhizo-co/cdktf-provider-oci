// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/data_safe_unset_user_assessment_baseline
...
export class DataSafeUnsetUserAssessmentBaseline extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataSafeUnsetUserAssessmentBaseline that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/data_safe_unset_user_assessment_baseline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/data_safe_unset_user_assessment_baseline oci_data_safe_unset_user_assessment_baseline} Resource
  *
  * @param scope The scope in which to define this construct
