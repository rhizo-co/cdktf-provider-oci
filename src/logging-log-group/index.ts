// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/logging_log_group
...
export class LoggingLogGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoggingLogGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/logging_log_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/logging_log_group oci_logging_log_group} Resource
  *
  * @param scope The scope in which to define this construct
