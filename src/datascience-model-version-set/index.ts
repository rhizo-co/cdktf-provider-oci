// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/datascience_model_version_set
...
export class DatascienceModelVersionSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatascienceModelVersionSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/datascience_model_version_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/datascience_model_version_set oci_datascience_model_version_set} Resource
  *
  * @param scope The scope in which to define this construct
