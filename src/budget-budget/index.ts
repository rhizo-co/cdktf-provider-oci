// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/budget_budget
...
export class BudgetBudget extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/budget_budget oci_budget_budget} Resource
  *
  * @param scope The scope in which to define this construct
