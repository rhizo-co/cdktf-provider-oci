// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/dns_tsig_key
...
export class DnsTsigKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsTsigKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/dns_tsig_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/dns_tsig_key oci_dns_tsig_key} Resource
  *
  * @param scope The scope in which to define this construct
