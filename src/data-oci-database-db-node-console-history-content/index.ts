...
export class DataOciDatabaseDbNodeConsoleHistoryContent extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseDbNodeConsoleHistoryContent that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/data-sources/database_db_node_console_history_content#import import section} in the documentation of this resource for the id to use
