// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/identity_policy
...
export class IdentityPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/identity_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/identity_policy oci_identity_policy} Resource
  *
  * @param scope The scope in which to define this construct
