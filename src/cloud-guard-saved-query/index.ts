// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/cloud_guard_saved_query
...
export class CloudGuardSavedQuery extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudGuardSavedQuery that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/cloud_guard_saved_query#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/cloud_guard_saved_query oci_cloud_guard_saved_query} Resource
  *
  * @param scope The scope in which to define this construct
