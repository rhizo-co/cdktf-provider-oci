// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/zpr_configuration
...
export class ZprConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZprConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/zpr_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/zpr_configuration oci_zpr_configuration} Resource
  *
  * @param scope The scope in which to define this construct
