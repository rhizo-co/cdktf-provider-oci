// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/database_management_external_asm
...
export class DatabaseManagementExternalAsm extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatabaseManagementExternalAsm that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/database_management_external_asm#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/database_management_external_asm oci_database_management_external_asm} Resource
  *
  * @param scope The scope in which to define this construct
