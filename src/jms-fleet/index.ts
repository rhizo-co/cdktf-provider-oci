// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/jms_fleet
...
export class JmsFleet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing JmsFleet that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/jms_fleet#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/jms_fleet oci_jms_fleet} Resource
  *
  * @param scope The scope in which to define this construct
