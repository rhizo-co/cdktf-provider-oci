// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/identity_identity_provider
...
export class IdentityIdentityProvider extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityIdentityProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/identity_identity_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/identity_identity_provider oci_identity_identity_provider} Resource
  *
  * @param scope The scope in which to define this construct
