// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/core_shape_management
...
export class CoreShapeManagement extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CoreShapeManagement that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/core_shape_management#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/core_shape_management oci_core_shape_management} Resource
  *
  * @param scope The scope in which to define this construct
