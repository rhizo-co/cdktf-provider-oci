// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/fleet_apps_management_maintenance_window
...
export class FleetAppsManagementMaintenanceWindow extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/fleet_apps_management_maintenance_window oci_fleet_apps_management_maintenance_window} Resource
  *
  ...
  */
  public constructor(scope: Construct, id: string, config: FleetAppsManagementMaintenanceWindowConfig) {
    ...
    this._maintenanceWindowType = config.maintenanceWindowType;
    this._recurrences = config.recurrences;
    this._taskInitiationCutoff = config.taskInitiationCutoff;
  ...
  // maintenance_window_type - computed: true, optional: true, required: false
  private _maintenanceWindowType?: string; 
  public get maintenanceWindowType() {
    return this.getStringAttribute('maintenance_window_type');
  }
  public set maintenanceWindowType(value: string) {
    this._maintenanceWindowType = value;
  }
  public resetMaintenanceWindowType() {
    this._maintenanceWindowType = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get maintenanceWindowTypeInput() {
    return this._maintenanceWindowType;
  }
  ...
  // task_initiation_cutoff - computed: true, optional: true, required: false
  private _taskInitiationCutoff?: number; 
  public get taskInitiationCutoff() {
    return this.getNumberAttribute('task_initiation_cutoff');
  }
  public set taskInitiationCutoff(value: number) {
    this._taskInitiationCutoff = value;
  }
  public resetTaskInitiationCutoff() {
    this._taskInitiationCutoff = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get taskInitiationCutoffInput() {
    return this._taskInitiationCutoff;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      maintenance_window_type: cdktf.stringToTerraform(this._maintenanceWindowType),
      recurrences: cdktf.stringToTerraform(this._recurrences),
      task_initiation_cutoff: cdktf.numberToTerraform(this._taskInitiationCutoff),
