// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/email_email_domain
...
export class EmailEmailDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EmailEmailDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/email_email_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/email_email_domain oci_email_email_domain} Resource
  *
  * @param scope The scope in which to define this construct
