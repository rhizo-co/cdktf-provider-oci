// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/email_suppression
...
export class EmailSuppression extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EmailSuppression that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/email_suppression#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/email_suppression oci_email_suppression} Resource
  *
  * @param scope The scope in which to define this construct
