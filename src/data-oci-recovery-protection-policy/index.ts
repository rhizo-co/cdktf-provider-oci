// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/data-sources/recovery_protection_policy
...
export class DataOciRecoveryProtectionPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciRecoveryProtectionPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/data-sources/recovery_protection_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/data-sources/recovery_protection_policy oci_recovery_protection_policy} Data Source
  *
  * @param scope The scope in which to define this construct
