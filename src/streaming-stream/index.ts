// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/streaming_stream
...
export class StreamingStream extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StreamingStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/streaming_stream#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/streaming_stream oci_streaming_stream} Resource
  *
  * @param scope The scope in which to define this construct
