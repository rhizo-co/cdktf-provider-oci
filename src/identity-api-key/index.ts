// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/identity_api_key
...
export class IdentityApiKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityApiKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/identity_api_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/identity_api_key oci_identity_api_key} Resource
  *
  * @param scope The scope in which to define this construct
