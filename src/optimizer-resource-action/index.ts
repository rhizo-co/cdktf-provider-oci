...
export class OptimizerResourceAction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OptimizerResourceAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/optimizer_resource_action#import import section} in the documentation of this resource for the id to use
