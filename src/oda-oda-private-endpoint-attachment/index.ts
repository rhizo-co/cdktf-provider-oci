// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/oda_oda_private_endpoint_attachment
...
export class OdaOdaPrivateEndpointAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OdaOdaPrivateEndpointAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/oda_oda_private_endpoint_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/oda_oda_private_endpoint_attachment oci_oda_oda_private_endpoint_attachment} Resource
  *
  * @param scope The scope in which to define this construct
