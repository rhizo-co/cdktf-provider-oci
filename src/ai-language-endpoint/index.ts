// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/ai_language_endpoint
...
export class AiLanguageEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AiLanguageEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/ai_language_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/ai_language_endpoint oci_ai_language_endpoint} Resource
  *
  * @param scope The scope in which to define this construct
