// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/core_service_gateway
...
export class CoreServiceGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CoreServiceGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/core_service_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/core_service_gateway oci_core_service_gateway} Resource
  *
  * @param scope The scope in which to define this construct
