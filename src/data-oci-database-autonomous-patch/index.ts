...
export class DataOciDatabaseAutonomousPatch extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseAutonomousPatch that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/data-sources/database_autonomous_patch#import import section} in the documentation of this resource for the id to use
