// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/fleet_apps_management_property
...
export class FleetAppsManagementProperty extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FleetAppsManagementProperty that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/fleet_apps_management_property#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/fleet_apps_management_property oci_fleet_apps_management_property} Resource
  *
  * @param scope The scope in which to define this construct
