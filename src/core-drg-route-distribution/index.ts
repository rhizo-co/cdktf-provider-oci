// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/core_drg_route_distribution
...
export class CoreDrgRouteDistribution extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CoreDrgRouteDistribution that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/core_drg_route_distribution#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/core_drg_route_distribution oci_core_drg_route_distribution} Resource
  *
  * @param scope The scope in which to define this construct
