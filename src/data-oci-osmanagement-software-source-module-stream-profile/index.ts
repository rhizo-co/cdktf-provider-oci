// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/data-sources/osmanagement_software_source_module_stream_profile
...
export class DataOciOsmanagementSoftwareSourceModuleStreamProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciOsmanagementSoftwareSourceModuleStreamProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/data-sources/osmanagement_software_source_module_stream_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/data-sources/osmanagement_software_source_module_stream_profile oci_osmanagement_software_source_module_stream_profile} Data Source
  *
  * @param scope The scope in which to define this construct
