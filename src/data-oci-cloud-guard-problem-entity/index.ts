...
export class DataOciCloudGuardProblemEntity extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCloudGuardProblemEntity that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/data-sources/cloud_guard_problem_entity#import import section} in the documentation of this resource for the id to use
