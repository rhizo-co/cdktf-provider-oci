// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/core_ipv6
...
export class CoreIpv6 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CoreIpv6 that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/core_ipv6#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/core_ipv6 oci_core_ipv6} Resource
  *
  * @param scope The scope in which to define this construct
