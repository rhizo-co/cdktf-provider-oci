...
export class DataOciDatabaseManagementExternalDbHome extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseManagementExternalDbHome that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/data-sources/database_management_external_db_home#import import section} in the documentation of this resource for the id to use
