// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/database_db_node_console_history
...
export class DatabaseDbNodeConsoleHistory extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatabaseDbNodeConsoleHistory that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/database_db_node_console_history#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/database_db_node_console_history oci_database_db_node_console_history} Resource
  *
  * @param scope The scope in which to define this construct
