// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/data_safe_alert
...
export class DataSafeAlert extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataSafeAlert that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/data_safe_alert#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/data_safe_alert oci_data_safe_alert} Resource
  *
  * @param scope The scope in which to define this construct
