...
export class DataOciDatabaseDbSystemPatches extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseDbSystemPatches that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/data-sources/database_db_system_patches#import import section} in the documentation of this resource for the id to use
