// https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/identity_db_credential
...
export class IdentityDbCredential extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityDbCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/identity_db_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.18.0/docs/resources/identity_db_credential oci_identity_db_credential} Resource
  *
  * @param scope The scope in which to define this construct
